...
[,rust,indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tag=tx_open]
----
--
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tag=tx_open]
----
--
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tag=tx_open]
----
--
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tag=tx_open]
----
--
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tag=options]
include::2.x@manual::partial$csharp-manual-code.cs[tag=tx_open]
----
--
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tag=options]
include::2.x@manual::partial$cpp-manual-code.cpp[tag=tx_open]
----
--
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tag=options]
include::2.x@manual::partial$c-manual-code.c[tag=tx_open]
----
--
====
...
[,rust,indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tag=tx_close]
----
--
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tag=tx_close]
----
--
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tag=tx_close]
----
--
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tag=tx_close]
----
--
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tag=tx_close]
----
--
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tag=tx_close]
----
--
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tag=tx_close]
----
--
...
[,rust,indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tag=tx_commit]
----
--
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tag=tx_commit]
----
--
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tag=tx_commit]
----
--
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tag=tx_commit]
----
--
...
[,csharp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tag=tx_commit]
----
--
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tag=tx_commit]
----
--
====
