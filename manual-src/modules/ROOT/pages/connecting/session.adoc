...
The `schema` session type is specifically employed for xref:2.x@typeql::queries/define.adoc[Define] and
xref:2.x@typeql::queries/undefine.adoc[Undefine] queries.
...
[,rust,indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tag=databases,indent=12]
include::2.x@manual::partial$rust-manual-code.rs[tag=session_open]
----
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tag=session_open]
----
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tag=session_open]
----
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tag=session_open]
----
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tag=session_open]
----
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tag=session_open]
----
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tag=session_open]
----
...
[,rust,indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tag=session_close]
----
--
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tag=session_close]
----
--
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tag=session_close]
----
--
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tag=session_close]
----
--
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tag=session_close]
----
--
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tag=session_close]
----
--
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tag=session_close]
----
--
====
