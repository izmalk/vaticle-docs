...
The `schema` session type is specifically employed for xref:3.x@typeql::queries/define.adoc[Define] and
xref:3.x@typeql::queries/undefine.adoc[Undefine] queries.
