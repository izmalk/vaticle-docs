= Connect to server
:page-aliases: 2.x@typedb::development/connect.adoc
:tabs-sync-option:
:experimental:
...
include::2.x@manual::studio.adoc[tag=connect_core_studio]
--
...
include::2.x@manual::console.adoc[tag=connect_core_console]
--
====
...
[,rust,indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tag=connect_core]
----
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tag=connect_core]
----
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tag=connect_core]
----
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tag=connect_core]
----
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tag=connect_core]
----
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tag=connect_core]
----
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tag=connect_core]
----
...
include::2.x@manual::studio.adoc[tag=connect_cloud_studio]

include::2.x@manual::studio.adoc[tag=first_login_studio]
--
...
include::2.x@manual::console.adoc[tag=connect_cloud_console]

include::2.x@manual::console.adoc[tag=cloud-psw]
--
====
...
[,rust,indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tag=connect_cloud]
----
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tag=connect_cloud]
----
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tag=connect_cloud]
----
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tag=connect_cloud]
----
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tag=connect_cloud]
----
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tag=connect_cloud]
----
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tag=connect_cloud]
----
