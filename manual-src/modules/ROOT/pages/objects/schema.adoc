...
[,rust,indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tag=get_type]
----
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tag=get_type]
----
For more information,
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tag=get_type]
----
For more information,
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tag=get_type]
----
For more information,
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tag=get_type]
----
For more information,
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tag=get_type]
----
For more information,
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tag=get_type]
----
For more information,
...
use a TypeQL xref:2.x@typeql::queries/define.adoc[Define query] or one of the put type methods.
...
[,rust,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tag=add_type]
----
For more information,
see the xref:drivers::rust/api-reference.adoc#_struct_ConceptManager[ConceptManager class] methods.
--
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tag=add_type]
----
For more information,
see the xref:drivers::nodejs/api-reference.adoc#_ConceptManager[ConceptManager class] methods.
--
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tag=add_type]
----
For more information,
see the xref:drivers::java/api-reference.adoc#_ConceptManager[ConceptManager class] methods.
--
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tag=add_type]
----
For more information,
see the xref:drivers::csharp/api-reference.adoc#_IConceptManager[IConceptManager class] methods.
--
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tag=add_type]
----
For more information,
see the xref:drivers::cpp/api-reference.adoc#_ConceptManager[ConceptManager class] methods.
--
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tag=add_type]
----
For more information,
see the xref:drivers::c/api-reference.adoc#_Struct_Concept[Concept struct] functions.
--
...
[,rust,indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tag=set_supertype]
----
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tag=set_supertype]
----
For more information on methods, available for manipulating Type objects,
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tag=set_supertype]
----
For more information on methods, available for manipulating Type objects,
see the xref:drivers::python/api-reference.adoc#_schema_header[Schema class] methods.
--
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tag=set_supertype]
----
For more information on methods, available for manipulating Type objects,
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tag=set_supertype]
----
For more information on methods, available for manipulating Type objects,
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tag=set_supertype]
----
For more information on methods, available for manipulating Type objects,
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tag=set_supertype]
----
For more information on methods, available for manipulating Type objects,
...
[,rust,indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tags=databases,indent=8]
include::2.x@manual::partial$rust-manual-code.rs[tags=types-api]
----
--
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tags=types-api]
----
--
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tags=types-api]
----
--
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tags=types-api]
----
--
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tags=types-api]
----
--
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tags=options,indent=0]
include::2.x@manual::partial$cpp-manual-code.cpp[tags=types-api,indent=0]
----
--
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tags=options,indent=0]
include::2.x@manual::partial$c-manual-code.c[tags=types-api,indent=0]
----
--
====
...
Rules can be defined with a TypeQL query (see xref:2.x@typeql::queries/define.adoc[]), but they can't be retrieved with one.
...
[,rust,indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tag=get_rule]
----
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tag=get_rule]
----
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tag=get_rule]
----
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tag=get_rule]
----
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tag=get_rule]
----
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tag=get_rule]
----
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tag=get_rule]
----
...
[,rust,indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tag=get_rules]
----
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tag=get_rules]
----
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tag=get_rules]
----
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tag=get_rules]
----
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tag=get_rules]
----
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tag=get_rules]
----
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tag=get_rules]
----
...
[,rust,indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tag=put_rule]
----
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tag=put_rule]
----
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tag=put_rule]
----
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tag=put_rule]
----
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tag=put_rule]
----
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tag=put_rule]
----
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tag=put_rule]
----
...
[,rust,indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tag=delete_rule]
----
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tag=delete_rule]
----
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tag=delete_rule]
----
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tag=delete_rule]
----
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tag=delete_rule]
----
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tag=delete_rule]
----
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tag=delete_rule]
----
...
[,rust,indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tags=rules-api]
----
--
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tags=rules-api]
----
--
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tags=rules-api]
----
--
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tags=rules-api]
----
--
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tags=rules-api]
----
--
...
----
include::2.x@manual::partial$cpp-manual-code.cpp[tags=options,indent=0]
include::2.x@manual::partial$cpp-manual-code.cpp[tags=rules-api,indent=0]
----
--
...
----
include::2.x@manual::partial$c-manual-code.c[tags=options,indent=0]
include::2.x@manual::partial$c-manual-code.c[tags=rules-api,indent=0]
----
--
====
...
include::2.x@manual::reading/get.adoc[tags=drivers-api]
