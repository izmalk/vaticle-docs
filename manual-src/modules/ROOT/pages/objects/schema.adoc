...
use a TypeQL xref:3.x@typeql::queries/define.adoc[Define query] or one of the put type methods.
...
Rules can be defined with a TypeQL query (see xref:3.x@typeql::queries/define.adoc[]), but they can't be retrieved with one.
