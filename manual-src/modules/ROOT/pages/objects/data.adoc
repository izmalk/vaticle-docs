...
[,rust,indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tag=get_instances]
----
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tag=get_instances]
----
For more information,
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tag=get_instances]
----
For more information,
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tag=get_instances]
----
For more information,
...
[,scharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tag=get_instances]
----
For more information,
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tag=get_instances]
----
For more information,
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tag=get_instances]
----
For more information,
...
[,rust,indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tag=get_has]
----
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tag=get_has]
----
For more information,
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tag=get_has]
----
For more information,
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tag=get_has]
----
For more information,
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tag=get_has]
----
For more information,
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tag=get_has]
----
For more information,
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tag=get_has]
----
For more information,
see the xref:drivers::c/api-reference.adoc#_concept_header[Concepts] section functions.
--
...
[,rust,indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tag=create]
----
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tag=create]
----
For more information,
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tag=create]
----
For more information,
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tag=create]
----
For more information,
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tag=create]
----
For more information,
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tag=create]
----
For more information,
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tag=create]
----
For more information,
...
[,rust,indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tag=delete_user]
----
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tag=delete_user]
----
For more information,
see the xref:drivers::python/api-reference.adoc#_EntityType[EntityType class] methods.
--
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tag=delete_user]
----
For more information,
see the xref:drivers::nodejs/api-reference.adoc#_EntityType[EntityType class] methods.
--
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tag=delete_user]
----
For more information,
see the xref:drivers::java/api-reference.adoc#_EntityType[EntityType class] methods.
--
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tag=delete_user]
----
For more information,
see the xref:drivers::csharp/api-reference.adoc#_IEntityType[IEntityType class] methods.
--
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tag=delete_user]
----
For more information,
see the xref:drivers::cpp/api-reference.adoc#_EntityType[EntityType class] methods.
--
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tag=delete_user]
----
For more information,
see the xref:drivers::c/api-reference.adoc#_Struct_Concept[Concepts] section functions.
--
...
include::2.x@manual::partial$rust-manual-code.rs[tags=data-api]
----
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tags=data-api]
----
For more information,
see the xref:drivers::python/api-reference.adoc#_data_header[Data class] methods.
--
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tags=data-api]
----
For more information,
see the xref:drivers::nodejs/api-reference.adoc#_data_header[Data class] methods.
--
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tags=data-api]
----
For more information,
see the xref:drivers::java/api-reference.adoc#_data_header[Data class] methods.
--
...
[,csharp]
----
include::2.x@manual::partial$csharp-manual-code.cs[tags=data-api]
----
For more information,
...
[,cpp]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tags=data-api]
----
For more information,
see the xref:drivers::cpp/api-reference.adoc#_data_header[Data class] methods.
--
...
[,c]
----
include::2.x@manual::partial$c-manual-code.c[tags=data-api]
----
For more information,
see the xref:drivers::c/api-reference.adoc#_Struct_Concept[Concepts] section functions.
--
