...
include::2.x@manual::partial$rust-manual-code.rs[tags=infer-fetch]
----
--
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tags=infer-fetch]
----
--
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tags=infer-fetch]
----
--
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tags=infer-fetch]
----
--
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tags=infer-fetch]
----
--
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tags=infer-fetch,indent=0]
----
--
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tags=infer-fetch]
----
--
====
