...
A Get query is used to retrieve _concepts_ from a TypeDB database. For a detailed explanation of the query see the xref:3.x@typeql::queries/get.adoc[] page.
