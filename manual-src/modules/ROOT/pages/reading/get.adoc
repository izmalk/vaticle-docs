...
A Get query is used to retrieve _concepts_ from a TypeDB database. For a detailed explanation of the query see the xref:2.x@typeql::queries/get.adoc[] page.
...
include::2.x@manual::partial$rust-manual-code.rs[tags=get]
----
--
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tags=get]
----
--
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tags=get]
----
--
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tags=get]
----
--
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tags=get]
----
--
...
include::2.x@manual::partial$cpp-manual-code.cpp[tags=get,indent=0]
----
--
...
include::2.x@manual::partial$c-manual-code.c[tags=get,indent=0]
----
--
====
