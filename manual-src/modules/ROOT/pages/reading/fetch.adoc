...
A Fetch query is used to retrieve _values_ and _types_ from a TypeDB database. For a detailed explanation of the query see the xref:2.x@typeql::queries/fetch.adoc[] page.
...
include::2.x@manual::partial$rust-manual-code.rs[tags=fetch]
----
--
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tags=fetch]
----
--
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tags=fetch]
----
--
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tags=fetch]
----
--
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tags=fetch]
----
--
...
include::2.x@manual::partial$cpp-manual-code.cpp[tags=fetch,indent=0]
----
--
...
include::2.x@manual::partial$c-manual-code.c[tags=fetch,indent=0]
----
--
====
