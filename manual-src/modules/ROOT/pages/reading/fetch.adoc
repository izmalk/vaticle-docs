...
A Fetch query is used to retrieve _values_ and _types_ from a TypeDB database. For a detailed explanation of the query see the xref:3.x@typeql::queries/fetch.adoc[] page.
