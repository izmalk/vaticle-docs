...
For a detailed explanation of the query see the xref:2.x@typeql::queries/update.adoc[] page.
...
include::2.x@manual::partial$rust-manual-code.rs[tags=update]
----
--
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tags=update]
----
--
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tags=update]
----
--
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tags=update]
----
--
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tags=update]
----
--
...
include::2.x@manual::partial$cpp-manual-code.cpp[tags=update,indent=0]
----
--
...
include::2.x@manual::partial$c-manual-code.c[tags=update,indent=0]
----
--
====
...
[cols-2]
--
.More about an xref:2.x@typeql::queries/update.adoc[]
[.clickable]
****
