...
A Delete query is used to delete _data_ from a TypeDB database. A `delete` clause is executed once per every result matched by the `match` clause of the same Delete query. For a detailed explanation of the query see the xref:2.x@typeql::queries/delete.adoc[] page.
...
[,rust,indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tags=delete]
----
--
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tags=delete]
----
--
...
[,js, indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tags=delete]
----
--
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tags=delete]
----
--
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tags=delete]
----
--
...
include::2.x@manual::partial$cpp-manual-code.cpp[tags=delete,indent=0]
----
--
...
include::2.x@manual::partial$c-manual-code.c[tags=delete,indent=0]
----
--
====
...
[cols-2]
--
.More about a xref:2.x@typeql::queries/delete.adoc[]
[.clickable]
****
