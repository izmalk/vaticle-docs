...
For a detailed explanation of the query see the xref:2.x@typeql::queries/delete.adoc[] page.
...
include::2.x@manual::partial$rust-manual-code.rs[tags=insert]
----
--
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tags=insert]
----
--
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tags=insert]
----
--
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tags=insert]
----
--
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tags=insert]
----
--
...
include::2.x@manual::partial$cpp-manual-code.cpp[tags=insert,indent=0]
----
--
...
include::2.x@manual::partial$c-manual-code.c[tags=insert,indent=0]
----
--
====
...
----
include::2.x@manual::partial$rust-manual-code.rs[tags=databases,indent=8]
include::2.x@manual::partial$rust-manual-code.rs[tags=match-insert]
----
--
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tags=match-insert]
----
--
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tags=match-insert]
----
--
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tags=match-insert]
----
--
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tags=match-insert]
----
--
...
----
include::2.x@manual::partial$cpp-manual-code.cpp[tags=options,indent=0]
include::2.x@manual::partial$cpp-manual-code.cpp[tags=match-insert,indent=0]
----
--
...
----
include::2.x@manual::partial$c-manual-code.c[tags=options,indent=0]
include::2.x@manual::partial$c-manual-code.c[tags=match-insert,indent=0]
----
--
====
...
[cols-2]
--
.More about an xref:2.x@typeql::queries/insert.adoc[]
[.clickable]
****
