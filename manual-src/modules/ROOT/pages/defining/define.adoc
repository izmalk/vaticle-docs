...
:experimental:
:scores: __
:page-aliases: 2.x@typedb::developing/defining-schema.adoc, 2.x@typedb::development/schema.adoc
...
For a detailed explanation of the query see the xref:2.x@typeql::queries/define.adoc[] page.
...
include::2.x@manual::partial$rust-manual-code.rs[tags=define]
----
--
...
[,python, indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tags=define]
----
--
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tags=define]
----
--
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tags=define]
----
--
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tags=define]
----
--
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tags=options,indent=8]
include::2.x@manual::partial$cpp-manual-code.cpp[tags=define]
----
--
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tags=options,indent=8]
include::2.x@manual::partial$c-manual-code.c[tags=define]
----
--
====
