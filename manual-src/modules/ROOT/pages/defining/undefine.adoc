...
A Undefine query is used to delete type and rule definitions from a schema. For a detailed explanation of the query see the xref:2.x@typeql::queries/undefine.adoc[] page. For an alternative way of editing your schema, see the xref:manual::defining/schema-editing.adoc[] page.
...
include::2.x@manual::partial$rust-manual-code.rs[tags=undefine]
----
--
...
[,python,indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tags=undefine]
----
--
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tags=undefine]
----
--
...
[,java,indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tags=undefine]
----
--
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tags=options]
include::2.x@manual::partial$csharp-manual-code.cs[tags=undefine]
----
--
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tags=options]
include::2.x@manual::partial$cpp-manual-code.cpp[tags=undefine]
----
--
...
[,cpp,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tags=options]
include::2.x@manual::partial$c-manual-code.c[tags=undefine]
----
--
====
