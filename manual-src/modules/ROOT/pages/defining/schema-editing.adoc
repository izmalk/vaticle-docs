...
include::2.x@manual::studio.adoc[tag=type-editor]
...
[,rust, indent=0]
----
include::2.x@manual::partial$rust-manual-code.rs[tags=types-editing]
----
...
[,python, indent=0]
----
include::2.x@manual::partial$python-manual-code.py[tags=types-editing]
----
...
[,js,indent=0]
----
include::2.x@manual::partial$nodejs-manual-code.js[tags=types-editing]
----
...
[,java, indent=0]
----
include::2.x@manual::partial$java-manual-code.java[tags=types-editing]
----
...
[,csharp,indent=0]
----
include::2.x@manual::partial$csharp-manual-code.cs[tags=types-editing]
----
...
[,cpp,indent=0]
----
include::2.x@manual::partial$cpp-manual-code.cpp[tags=types-editing]
----
...
[,c,indent=0]
----
include::2.x@manual::partial$c-manual-code.c[tags=types-editing]
----
