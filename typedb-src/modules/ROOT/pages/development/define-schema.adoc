...
A schema contains all user-defined xref:typeql:ROOT:fundamentals/types.adoc#_type[types] and
xref:typeql:ROOT:fundamentals/inference.adoc#_rules[rules] that can be used in the database.
