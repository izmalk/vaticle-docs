...
.See how to manage a transaction and send a query
[%collapsible]
====
...
----
// prepare queries
String insertQuery1 = 'insert $x isa person, has full-name "Bob", has email "bob@vaticle.com";';
String insertQuery2 = 'insert $x isa person, has full-name "Alex", has email "alex@vaticle.com";';
String insertQueryN = 'insert $x isa person, has full-name "Charlie", has email "char@vaticle.com";';
// start transaction
...
----
# prepare queries
insertQuery1 = 'insert $x isa person, has full-name "Bob", has email "bob@vaticle.com";'
insertQuery2 = 'insert $x isa person, has full-name "Alex", has email "alex@vaticle.com";'
insertQueryN = 'insert $x isa person, has full-name "Charlie", has email "char@vaticle.com";'
# start transaction
...
----
// prepare queries
let insertQuery1 = 'insert $x isa person, has full-name "Bob", has email "bob@vaticle.com";';
let insertQuery2 = 'insert $x isa person, has full-name "Alex", has email "alex@vaticle.com";';
let insertQueryN = 'insert $x isa person, has full-name "Charlie", has email "char@vaticle.com";';
// start transaction
