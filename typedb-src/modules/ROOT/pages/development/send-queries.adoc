...
[#_databases]
== Databases
//#todo Try not to repeat the database section
...
To delete a database, click on a Delete button with red bin icon in the line of the database to delete in the list.
--
