...
| 2
| Get query with xref:typeql::queries/get.adoc#_aggregation[aggregation,window=_blank]
| *Future* of *Numeric*

| 3
| Get query with xref:typeql::queries/get.adoc#_group[grouping,window=_blank]
| Stream/Iterator of *ConceptMapGroup*

| 4
| Get query with xref:typeql::queries/get.adoc#_group[grouping,window=_blank] and
xref:typeql::queries/get.adoc#_aggregation[aggregation,window=_blank]
...
| 8
| xref:typedb::development/schema.adoc#_types[Define]
| *Future* (of empty response)
