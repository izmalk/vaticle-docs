...
After the first installation of TypeDB, we recommend using our xref:root/quickstart-guide.adoc[Quickstart guide]
...
To find out only essential information about TypeDB, check the xref:basics/learn-basics.adoc[] page.
