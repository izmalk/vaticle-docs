...
Open the xref:cloud:ROOT:account.adoc#_settings[Account settings] page.
...
include::cloud:ROOT:user-management/organization.adoc[tag=intro]

include::cloud:ROOT:user-management/organization.adoc[tag=join_organization]

=== Team

include::cloud:ROOT:user-management/team.adoc[tag=intro]

include::cloud:ROOT:user-management/team.adoc[tag=invite]

=== Project

include::cloud:ROOT:deployments/projects.adoc[tag=intro]

include::cloud:ROOT:deployments/projects.adoc[tag=user]

See the xref:cloud:ROOT:account.adoc#_team[Team] section above.
