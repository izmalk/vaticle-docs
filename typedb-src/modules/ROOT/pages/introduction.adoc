...
. Create a database and try some queries with the xref:root/quickstart-guide.adoc[Quickstart guide].
. Learn only essentials about TypeDB with the xref:basics/learn-basics.adoc[] page.
