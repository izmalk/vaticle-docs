...
include::typeql:ROOT:partial$fundamentals.adoc[tag=rules_basics]

include::typeql:ROOT:partial$fundamentals.adoc[tag=recursive_logic]
...
include::typeql::schema/define.adoc[tag=rule_validation]
