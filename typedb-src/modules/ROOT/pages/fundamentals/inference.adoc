...
include::typeql:ROOT:schema/fundamentals.adoc[tag=rules_basics]

include::typeql:ROOT:schema/fundamentals.adoc[tag=recursive_logic]
...
include::typeql::schema/rules.adoc[tag=rule_validation]
