...
include::typeql:ROOT:partial$fundamentals.adoc[tag=types_basics]

[#_inheritance]
== Inheritance

include::typeql:ROOT:partial$fundamentals.adoc[tag=inheritance_basics]

[#_abstract_types]
== Abstract types

include::typeql:ROOT:partial$fundamentals.adoc[tag=abstract_basics]
...
include::typeql:ROOT:partial$fundamentals.adoc[tag=thing_type_basics]

[#_entity_types]
=== Entity types

include::typeql:ROOT:partial$fundamentals.adoc[tag=entity_type_basics]
...
include::typeql:ROOT:partial$fundamentals.adoc[tag=relation_type_basics]

include::typeql:ROOT:partial$fundamentals.adoc[tag=relation_type_examples]
...
include::typeql:ROOT:partial$fundamentals.adoc[tag=attribute_type_basics]
...
include::typeql:ROOT:partial$fundamentals.adoc[tag=attribute_type_example]

include::typeql:ROOT:partial$fundamentals.adoc[tag=attribute_type_own_depr]
