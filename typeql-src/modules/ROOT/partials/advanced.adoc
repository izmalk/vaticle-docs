...
Explore the xref:typeql::queries/match.adoc[] page before continue reading this page.
...
xref:typeql::queries/match.adoc#_combining_statements[combined] with other statements
to find types defined in a database's schema.
Use the xref:schema/types.adoc[Define] query to try them.
...
xref:typeql::queries/match.adoc#_combining_statements[combination] with other statements
to find data in a database.
Use the xref:queries/get.adoc[Get] query to try them.
...
For more information on xref:typeql::queries/match.adoc#_comparison_operators[comparison operators],
xref:typeql::queries/match.adoc#_computation[computation], and
xref:typeql::queries/match.adoc#_combining_statements[combining statements]
-- see the xref:typeql::queries/match.adoc[] page.
...
the xref:partial$fundamentals.adoc#_thing_type[Thing type] section.
...
For more information on `thing` type see the xref:partial$fundamentals.adoc#_thing_type[Thing type] section.
...
For more information on how to use the Get query please see the xref:typeql::queries/get.adoc[] page.
...
For more information on the Insert query please see the xref:typeql::queries/insert.adoc[] page.
...
For more information on how to delete data please see the xref:typeql::queries/delete.adoc[] page.
...
For more information on how to use the Update query see the xref:typeql::queries/update.adoc[] page.
