...
Patterns are xref:3.x@typeql::patterns/matching.adoc[built] from xref:3.x@typeql::statements/overview.adoc[statements]
...
xref:3.x@typeql::patterns/conjunction.adoc[conjunction].
