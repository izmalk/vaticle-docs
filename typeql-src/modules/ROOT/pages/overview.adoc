...
To learn about the principles and design of TypeQL, see our xref:3.x@typeql::introduction.adoc[] page.
...
A list of TypeQL keywords used in clauses, schema statements, and data statements, can be found on our xref:3.x@typeql::keywords.adoc[] page.