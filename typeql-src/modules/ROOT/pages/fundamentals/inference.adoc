...
[#_inference]
TypeDB is capable of reasoning over data via rules xref:typedb:ROOT:development/define-schema.adoc#_define_rules[defined] in the schema.
...
Read more on how to create rules in a schema in the xref:typedb:ROOT:development/define-schema.adoc#_define_rules[Define rules]
