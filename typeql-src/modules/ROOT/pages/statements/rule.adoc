...
either a xref:2.x@typeql::statements/has.adoc[has statement],
or an xref:2.x@typeql::statements/isa.adoc[isa statement] for a relation with any number of roles.
