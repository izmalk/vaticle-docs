...
xref:3.x@typeql::statements/owns.adoc[owns statement] to specify, that the selected attribute type must be uniquely owned by data instances of a given type.
