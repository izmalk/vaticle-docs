...
When inserting an attribute, you can provide a value with a xref:2.x@typeql::statements/value-assignment.adoc[] syntax:
...
you can provide role players for every role with a xref:2.x@typeql::statements/role-assignment.adoc[] syntax:
