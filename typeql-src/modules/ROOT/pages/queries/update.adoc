...
:page-aliases: 2.x@typeql::data/update.adoc
...
xref:2.x@typeql::statements/role-assignment.adoc[role assignment], and
...
see the xref:2.x@typeql::queries/delete.adoc[] and xref:2.x@typeql::queries/insert.adoc[] page.
...
consider specifying xref:2.x@typeql::statements/unique.adoc[uniqueness annotation]
