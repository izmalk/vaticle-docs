...
:page-aliases: 3.x@typeql::data/update.adoc
...
xref:3.x@typeql::statements/role-assignment.adoc[role assignment], and
...
see the xref:3.x@typeql::queries/delete.adoc[] and xref:3.x@typeql::queries/insert.adoc[] page.
...
consider specifying xref:3.x@typeql::statements/unique.adoc[uniqueness annotation]
