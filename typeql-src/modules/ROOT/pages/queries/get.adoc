...
:pageTitle: Get query
:page-aliases: 2.x@typeql::data/get.adoc
...
A Get query retrieves xref:2.x@typeql::concepts/overview.adoc[concepts] from a database.
...
xref:2.x@typeql::modifiers/aggregation.adoc[aggregation], xref:2.x@typeql::modifiers/grouping.adoc[grouping], or both.
See the <<_response>> section below.

You can use xref:2.x@typeql::modifiers/sorting.adoc[sorting] and
xref:2.x@typeql::modifiers/pagination.adoc[pagination] with a Get query.
...
optionally processed by xref:2.x@typeql::modifiers/overview.adoc[modifiers].
...
Applying xref:2.x@typeql::modifiers/overview.adoc[modifiers] can have a drastic effect on the format and number
of results returned by a Get query.
See the <<_table_output_types,table above>> for output formats depending on the usage of
xref:2.x@typeql::modifiers/grouping.adoc[grouping]
and xref:2.x@typeql::modifiers/aggregation.adoc[aggregation].

Usage of the xref:2.x@typeql::modifiers/pagination.adoc#_limit_the_results[limit] modifier directly sets a limitation
for the number of results.

Combination of <<_get_clause_filtering>> and xref:2.x@typeql::modifiers/sorting.adoc[] can produce
...
The xref:2.x@typeql::modifiers/aggregation.adoc#_count[count modifier] is added to get the number of results,
...
For more information on an Insert query, see the xref:2.x@typeql::queries/insert.adoc[] page.
====
