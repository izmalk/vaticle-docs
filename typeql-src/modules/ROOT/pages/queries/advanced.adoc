...
the xref:schema/fundamentals.adoc#_thing_type[Thing type] section.
...
For more information on `thing` type see the xref:schema/fundamentals.adoc#_thing_type[Thing type] section.
