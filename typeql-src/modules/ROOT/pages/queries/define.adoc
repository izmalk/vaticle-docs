...
:page-aliases: 2.x@typeql::schema/define.adoc, 2.x@typeql::type-definitions.adoc, 2.x@typeql::rule-definitions.adoc
...
and annotations: xref:2.x@typeql::statements/key.adoc[] and xref:2.x@typeql::statements/unique.adoc[].
...
// see below and the xref:2.x@typeql::schema/type-definitions.adoc[].
...
xref:2.x@typeql::statements/overview.adoc#_annotation_statements[annotations] and
...
To define a new type, subtype an existing type with a xref:2.x@typeql::statements/sub.adoc[sub] statement.
Use xref:2.x@typeql::statements/owns.adoc[owns] statements to assign an ability to own attribute types.

For roles on relations, use xref:2.x@typeql::statements/relates.adoc[relates] and
xref:2.x@typeql::statements/plays.adoc[plays] statements.

Simple statements about the same subject can be combined in a
xref:2.x@typeql::statements/overview.adoc#_composite_statements[composite statement].
...
Use a xref:2.x@typeql::statements/rule.adoc[rule] statement to define a new rule or replace an existing one:
