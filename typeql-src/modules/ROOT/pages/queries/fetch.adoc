...
:page-aliases: 2.x@typeql::data/fetch.adoc
...
xref:2.x@typeql::modifiers/pagination.adoc[pagination] with a Fetch query.
...
To fetch a value, you can either fetch a xref:2.x@typeql::concepts/concept-variables.adoc[concept variable]
with an attribute, or fetch a xref:2.x@typeql::values/value-variables.adoc[value variable].
...
xref:2.x@typeql::statements/isa.adoc[isa] or xref:2.x@typeql::statements/sub.adoc[sub] statement.
...
xref:2.x@typeql::queries/get.adoc[Get query] with
xref:2.x@typeql::modifiers/aggregation.adoc[aggregation] that returns a value.
...
You can use xref:2.x@typeql::queries/get.adoc[Get] queries as subqueries as long as you use
xref:2.x@typeql::queries/get.adoc#_aggregation[aggregation] to get a value.
...
xref:2.x@typeql::modifiers/aggregation.adoc[aggregation modifier].
