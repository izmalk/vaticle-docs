...
:page-aliases: 3.x@typeql::schema/undefine.adoc
...
and annotations: xref:3.x@typeql::statements/key.adoc[] and xref:3.x@typeql::statements/unique.adoc[]. Schema statements in a `undefine` clause can't use any variables or values, except for xref:statements/rule.adoc[rules].
// end::syntax[]
