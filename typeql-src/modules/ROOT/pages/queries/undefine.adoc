...
:page-aliases: 2.x@typeql::schema/undefine.adoc
...
and annotations: xref:2.x@typeql::statements/key.adoc[] and xref:2.x@typeql::statements/unique.adoc[]. Schema statements in a `undefine` clause can't use any variables or values, except for xref:statements/rule.adoc[rules].
// end::syntax[]
