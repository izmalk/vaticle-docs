...
Concept variables in TypeQL represent unknown xref:2.x@typeql::concepts/types.adoc[types] and
xref:2.x@typeql::concepts/data-instances.adoc[data instances] in data query patterns.
...
* Any value operations, including xref:2.x@typeql::values/arithmetic.adoc[arithmetic operations],
xref:2.x@typeql::values/comparators.adoc[comparators],
xref:2.x@typeql::values/functions.adoc[built-in functions] can be applied only to attributes.
