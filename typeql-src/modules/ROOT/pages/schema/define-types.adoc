...
xref:typedb:ROOT:root/quickstart-guide.adoc[Quickstart guide] for full descriptions of the following steps:
...
include::typedb:ROOT:root/quickstart-guide.adoc[tag=thing_deprecation]
