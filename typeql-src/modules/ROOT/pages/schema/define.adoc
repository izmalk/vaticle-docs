...
See the xref:schema/fundamentals.adoc[] page for more information about xref:schema/fundamentals.adoc#_schema[schema]
and xref:schema/fundamentals.adoc#_types[types].
