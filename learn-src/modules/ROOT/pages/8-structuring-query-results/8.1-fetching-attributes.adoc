...
Try *running* image:learn::studio-icons/run-query.png[] these queries to see the difference. In addition to having two different output formats, these queries act differently on the data. In this lesson, we'll examine the difference between these two methods and learn when to apply each one.
...
[,typeql]
----
include::2.x@learn::attachment$bookstore-schema.tql[lines=18..]
----
=====
