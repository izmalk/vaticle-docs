...
If we *run* image:learn::studio-icons/run-query.png[] the query above, then we will see it gives the intended results! Let's examine the subquery to see how this works.
