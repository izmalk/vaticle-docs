...
[source,python]
----
attribute_type.as_remote(tx).set_supertype(attribute_type)
----
...
[source,python]
----
attribute_type.as_remote(tx).get_subtypes()
----
...
[source,python]
----
attribute_type.as_remote(tx).get_instances()
----
