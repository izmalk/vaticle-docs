...
To use the TypeDB Python Driver, we need a compatible version of TypeDB server running. Please see the
...
* https://github.com/vaticle/typedb-client-python/releases[Releases prior to 2.24.0,window=_blank]
