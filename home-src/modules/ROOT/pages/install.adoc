...
// tag::body[]
This page contains installation instructions for TypeDB Core, Studio, Console, and drivers.
...
see the xref:guides::installation/cloud.adoc[Self-hosted TypeDB Cloud] page.
// end::self-hosted-run[]
