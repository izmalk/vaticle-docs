...
image::cloud-hero.png[TypeDB Cloud hero image, role="framed right", width = 50%, window=_blank, link=https://cloud.typedb.com/]

TypeDB Cloud is a production-ready and scalable version of TypeDB with advanced security and high-availability features.

// tag::cloud-run[]
Available without installation with our fully managed cloud service:
log in to the https://cloud.typedb.com/[cloud.typedb.com,window=_blank]
and create a new deployment on the Deployments page.
// end::cloud-run[]

// tag::self-hosted-run[]
For TypeDB Cloud Self-hosted installation and setup,
