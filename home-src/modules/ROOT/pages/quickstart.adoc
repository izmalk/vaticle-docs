...
:page-aliases: 2.x@typedb::quickstart-guide.adoc, 2.x@typedb::quickstart.adoc
...
include::2.x@home::overview.adoc[tag=rust-rewrite]
...
include::2.x@home::install/core.adoc[tag=core-run]
...
// end::run_studio[]
include::2.x@manual::studio.adoc[tag=connect_studio]
...
[,typeql]
----
include::2.x@attachment$crash-course-schema.tql[]
----
...
[,typeql]
----
include::2.x@attachment$crash-course-data.tql[]
----
