...
:page-aliases: 2.x@typedb::managing/self-hosted-deployment.adoc, 2.x@typedb::admin/enterprise-deployment.adoc
:experimental:
...
include::2.x@manual::partial$kubernetes.adoc[leveloffset=+1]
