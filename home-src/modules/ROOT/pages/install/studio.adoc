...
https://repo.typedb.com/public/public-release/raw/names/typedb-studio-mac-x86_64/versions/2.27.0/typedb-studio-mac-x86_64-2.27.0.dmg[x86/x64] |
...
--
. Download the latest package for your system architecture:
https://repo.typedb.com/public/public-release/raw/names/typedb-studio-linux-x86_64/versions/2.27.0/typedb-studio-linux-x86_64-2.27.0.tar.gz[x86/x64] |
...
https://repo.typedb.com/public/public-release/raw/names/typedb-studio-windows-x86_64/versions/2.27.0/typedb-studio-windows-x86_64-2.27.0.exe[x86/x64]. +
For other versions, see the
...
include::2.x@manual::studio.adoc[tags="latest-compatibility,older-compatibility"]
