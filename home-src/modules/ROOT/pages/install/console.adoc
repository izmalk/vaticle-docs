...
include::2.x@manual:resources:partial$typedb-console-latest-links.adoc[tag=mac]
+
...
--
. Download the latest package for your system architecture:
include::2.x@manual:resources:partial$typedb-console-latest-links.adoc[tag=linux]
+
For other versions, see the
...
--
. Download the latest package for your system architecture:
include::2.x@manual:resources:partial$typedb-console-latest-links.adoc[tag=windows]
+
For other versions, see the
...
include::2.x@manual::console.adoc[tags="latest-compatibility,older-compatibility"]
