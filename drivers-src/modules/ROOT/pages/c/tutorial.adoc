...
. Download the https://cloudsmith.io/~typedb/packages/?q=clib&sort=-version[TypeDB C driver].
For the driver installation instructions, see the xref:drivers::c/overview.adoc[] page.
...
[,c,indent=0]
----
include::2.x@drivers::partial$tutorials/c/tutorial.c[tag=import]
----
...
[,c,indent=0]
----
include::2.x@drivers::partial$tutorials/c/tutorial.c[tag=constants]
----
...
`FAILED()` is used for error handling, see the <<_error_handling>> section for details.
...
[,c,indent=0]
----
include::2.x@drivers::partial$tutorials/c/tutorial.c[tag=main]
----

The entire `main()` function code is executed in the context of the <<_typedb_connection,network connection>>,
represented by the `connection` object that is returned by the function.
...
[,c,indent=0]
----
include::2.x@drivers::partial$tutorials/c/tutorial.c[tag=connection]
----
...
TypeDB Cloud connection requires an object of the `Credential` type
...
include::2.x@partial$tutorials/change-psw.adoc[]
...
[,c,indent=0]
----
include::2.x@drivers::partial$tutorials/c/tutorial.c[tag=db-setup]
----
...
[,c,indent=0]
----
include::2.x@drivers::partial$tutorials/c/tutorial.c[tag=create_new_db]
----
...
[,c,indent=0]
----
include::2.x@drivers::partial$tutorials/c/tutorial.c[tag=replace_db]
----

[#_defining_a_schema]
=== Defining a schema

We use a xref:2.x@typeql::queries/define.adoc[Define query] to define a schema for the newly created database:

[,c,indent=0]
----
include::2.x@drivers::partial$tutorials/c/tutorial.c[tag=db-schema-setup]
----
...
[,typeql]
----
include::2.x@drivers::partial$tutorials/iam-schema.tql[lines=17..]
----
====
...
xref:2.x@typeql::queries/insert.adoc[Insert query]:

[,c,indent=0]
----
include::2.x@drivers::partial$tutorials/c/tutorial.c[tag=db-dataset-setup]
----
...
[,typeql]
----
include::2.x@drivers::partial$tutorials/iam-data-single-query.tql[lines=17..]
----
====
...
[,c,indent=0]
----
include::2.x@drivers::partial$tutorials/c/tutorial.c[tag=test-db]
----
...
[,js,indent=0]
----
include::2.x@drivers::partial$tutorials/c/tutorial.c[tag=queries]
----
...
Let's use a xref:2.x@typeql::queries/fetch.adoc[Fetch query] to fetch names and emails for all users in the database:

[,c,indent=0]
----
include::2.x@drivers::partial$tutorials/c/tutorial.c[tag=fetch]
----
...
[,c,indent=0]
----
include::2.x@drivers::partial$tutorials/c/tutorial.c[tag=insert]
----
...
[,c,indent=0]
----
include::2.x@drivers::partial$tutorials/c/tutorial.c[tag=get]
----
...
and assigning it with ownership of the new path attribute with the xref:2.x@typeql::queries/update.adoc[Update query]:

[,c,indent=0]
----
include::2.x@drivers::partial$tutorials/c/tutorial.c[tag=update]
----
...
we proceed with a xref:2.x@typeql::queries/delete.adoc[Delete query] with the same match clause.
...
[,c,indent=0]
----
include::2.x@drivers::partial$tutorials/c/tutorial.c[tag=delete]
----
...
[,c,indent=0]
----
include::2.x@drivers::partial$tutorials/c/tutorial.c[tag=error_handling]
----
...
.xref:drivers::c/api-reference.adoc[]
[.clickable]
****
