...
[,c,indent=0]
----
include::drivers::partial$tutorials/c/tutorial.c[tag=import]
----
...
[,c,indent=0]
----
include::drivers::partial$tutorials/c/tutorial.c[tag=constants]
----
...
[,c,indent=0]
----
include::drivers::partial$tutorials/c/tutorial.c[tag=main]
----
...
[,c,indent=0]
----
include::drivers::partial$tutorials/c/tutorial.c[tag=connection]
----
...
[,c,indent=0]
----
include::drivers::partial$tutorials/c/tutorial.c[tag=db-setup]
----
...
[,c,indent=0]
----
include::drivers::partial$tutorials/c/tutorial.c[tag=create_new_db]
----
...
[,c,indent=0]
----
include::drivers::partial$tutorials/c/tutorial.c[tag=replace_db]
----

[#_defining_a_schema]
=== Defining a schema

We use a xref:3.x@typeql::queries/define.adoc[Define query] to define a schema for the newly created database:

[,c,indent=0]
----
include::drivers::partial$tutorials/c/tutorial.c[tag=db-schema-setup]
----
...
xref:3.x@typeql::queries/insert.adoc[Insert query]:

[,c,indent=0]
----
include::drivers::partial$tutorials/c/tutorial.c[tag=db-dataset-setup]
----
...
[,c,indent=0]
----
include::drivers::partial$tutorials/c/tutorial.c[tag=test-db]
----
...
[,js,indent=0]
----
include::drivers::partial$tutorials/c/tutorial.c[tag=queries]
----
...
Let's use a xref:3.x@typeql::queries/fetch.adoc[Fetch query] to fetch names and emails for all users in the database:

[,c,indent=0]
----
include::drivers::partial$tutorials/c/tutorial.c[tag=fetch]
----
...
[,c,indent=0]
----
include::drivers::partial$tutorials/c/tutorial.c[tag=insert]
----
...
[,c,indent=0]
----
include::drivers::partial$tutorials/c/tutorial.c[tag=get]
----
...
and assigning it with ownership of the new path attribute with the xref:3.x@typeql::queries/update.adoc[Update query]:

[,c,indent=0]
----
include::drivers::partial$tutorials/c/tutorial.c[tag=update]
----
...
we proceed with a xref:3.x@typeql::queries/delete.adoc[Delete query] with the same match clause.
...
[,c,indent=0]
----
include::drivers::partial$tutorials/c/tutorial.c[tag=delete]
----
...
[,c,indent=0]
----
include::drivers::partial$tutorials/c/tutorial.c[tag=error_handling]
----
