...
[,rust,indent=0]
----
include::2.x@drivers::partial$tutorials/rust/src/main.rs[tag=import]
----
...
[,rust,indent=0]
----
include::2.x@drivers::partial$tutorials/rust/src/main.rs[tag=constants]
----
...
[,rust,indent=0]
----
include::2.x@drivers::partial$tutorials/rust/src/main.rs[tag=main]
----
...
[,rust]
----
include::2.x@drivers::partial$tutorials/rust/src/main.rs[tag=connection]
----
...
[,rust]
----
include::2.x@drivers::partial$tutorials/rust/src/main.rs[tag=db-setup]
----
...
[,rust]
----
include::2.x@drivers::partial$tutorials/rust/src/main.rs[tag=create_new_db]
----
...
[,rust, indent=0]
----
include::2.x@drivers::partial$tutorials/rust/src/main.rs[tag=replace_db]
----
...
[,rust]
----
include::2.x@drivers::partial$tutorials/rust/src/main.rs[tag=db-schema-setup]
----
...
[,rust]
----
include::2.x@drivers::partial$tutorials/rust/src/main.rs[tag=db-dataset-setup]
----
...
[,rust]
----
include::2.x@drivers::partial$tutorials/rust/src/main.rs[tag=test-db]
----
...
[,rust,indent=0]
----
include::2.x@drivers::partial$tutorials/rust/src/main.rs[tag=queries]
----
...
[,rust]
----
include::2.x@drivers::partial$tutorials/rust/src/main.rs[tag=fetch]
----
...
[,rust]
----
include::2.x@drivers::partial$tutorials/rust/src/main.rs[tag=insert]
----
...
[,rust]
----
include::2.x@drivers::partial$tutorials/rust/src/main.rs[tag=get]
----
...
[,rust]
----
include::2.x@drivers::partial$tutorials/rust/src/main.rs[tag=update]
----
...
[,rust]
----
include::2.x@drivers::partial$tutorials/rust/src/main.rs[tag=delete]
----
