...
[,js,indent=0]
----
include::2.x@drivers::partial$tutorials/nodejs/sample.js[tag=import]
----
...
[,js,indent=0]
----
include::2.x@drivers::partial$tutorials/nodejs/sample.js[tag=constants]
----
...
[,js,indent=0]
----
include::2.x@drivers::partial$tutorials/nodejs/sample.js[tag=main]
----
...
[,js,indent=0]
----
include::2.x@drivers::partial$tutorials/nodejs/sample.js[tag=connection]
----
...
[,js,indent=0]
----
include::2.x@drivers::partial$tutorials/nodejs/sample.js[tag=db-setup]
----
...
[,js,indent=0]
----
include::2.x@drivers::partial$tutorials/nodejs/sample.js[tag=create_new_db]
----
...
[,js, indent=0]
----
include::2.x@drivers::partial$tutorials/nodejs/sample.js[tag=replace_db]
----
...
[,js,indent=0]
----
include::2.x@drivers::partial$tutorials/nodejs/sample.js[tag=db-schema-setup]
----
...
[,js,indent=0]
----
include::2.x@drivers::partial$tutorials/nodejs/sample.js[tag=db-dataset-setup]
----
...
[,js,indent=0]
----
include::2.x@drivers::partial$tutorials/nodejs/sample.js[tag=test-db]
----
...
[,js,indent=0]
----
include::2.x@drivers::partial$tutorials/nodejs/sample.js[tag=queries]
----
...
[,js,indent=0]
----
include::2.x@drivers::partial$tutorials/nodejs/sample.js[tag=fetch]
----
...
[,js,indent=0]
----
include::2.x@drivers::partial$tutorials/nodejs/sample.js[tag=insert]
----
...
[,js,indent=0]
----
include::2.x@drivers::partial$tutorials/nodejs/sample.js[tag=get]
----
...
[,js,indent=0]
----
include::2.x@drivers::partial$tutorials/nodejs/sample.js[tag=update]
----
...
[,js,indent=0]
----
include::2.x@drivers::partial$tutorials/nodejs/sample.js[tag=delete]
----
