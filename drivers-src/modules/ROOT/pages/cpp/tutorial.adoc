...
. Download the https://cloudsmith.io/~typedb/repos/public-release/packages/?q=cpp&sort=-version[TypeDB C++ driver].
For the driver installation instructions, see the xref:drivers::cpp/overview.adoc[] page.
...
[,cpp,indent=0]
----
include::2.x@drivers::partial$tutorials/cpp/main.cpp[tag=import]
----
...
[,cpp,indent=0]
----
include::2.x@drivers::partial$tutorials/cpp/main.cpp[tag=constants]
----
...
[,cpp,indent=0]
----
include::2.x@drivers::partial$tutorials/cpp/main.cpp[tag=main]
----
...
[,cpp]
----
include::2.x@drivers::partial$tutorials/cpp/main.cpp[tag=connection]
----
...
TypeDB Cloud connection requires an object of the `TypeDB::Credential` class
...
[,cpp]
----
include::2.x@drivers::partial$tutorials/cpp/main.cpp[tag=db-setup]
----
...
[,cpp]
----
include::2.x@drivers::partial$tutorials/cpp/main.cpp[tag=create_new_db]
----
...
[,cpp]
----
include::2.x@drivers::partial$tutorials/cpp/main.cpp[tag=replace_db]
----
...
[,cpp]
----
include::2.x@drivers::partial$tutorials/cpp/main.cpp[tag=db-schema-setup]
----
...
[,cpp]
----
include::2.x@drivers::partial$tutorials/cpp/main.cpp[tag=db-dataset-setup]
----
...
[,cpp]
----
include::2.x@drivers::partial$tutorials/cpp/main.cpp[tag=test-db]
----
...
[,js,indent=0]
----
include::2.x@drivers::partial$tutorials/cpp/main.cpp[tag=queries]
----
...
[,cpp]
----
include::2.x@drivers::partial$tutorials/cpp/main.cpp[tag=fetch]
----

We get the response as a stream of JSONs and iterate through it to print all String values from each JSON.
To print the values, we use the `printJSON()` function:

[,cpp]
----
include::2.x@drivers::partial$tutorials/cpp/main.cpp[tag=json]
----
...
[,cpp]
----
include::2.x@drivers::partial$tutorials/cpp/main.cpp[tag=insert]
----
...
[,cpp]
----
include::2.x@drivers::partial$tutorials/cpp/main.cpp[tag=get]
----
...
[,cpp]
----
include::2.x@drivers::partial$tutorials/cpp/main.cpp[tag=update]
----
...
[,cpp]
----
include::2.x@drivers::partial$tutorials/cpp/main.cpp[tag=delete]
----
...
.xref:drivers::cpp/api-reference.adoc[]
[.clickable]
****
