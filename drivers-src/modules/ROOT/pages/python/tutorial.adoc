...
:page-aliases: 2.x@typedb::tutorials/sample-app.adoc
...
[,python,indent=0]
----
include::2.x@drivers::partial$tutorials/python/sample.py[tag=import]
----
...
[,python,indent=0]
----
include::2.x@drivers::partial$tutorials/python/sample.py[tag=constants]
----
...
[,python,indent=0]
----
include::2.x@drivers::partial$tutorials/python/sample.py[tag=main]
----
...
[,python]
----
include::2.x@drivers::partial$tutorials/python/sample.py[tag=connection]
----
...
[,python]
----
include::2.x@drivers::partial$tutorials/python/sample.py[tag=db-setup]
----
...
[,python]
----
include::2.x@drivers::partial$tutorials/python/sample.py[tag=create_new_db]
----
...
[,python]
----
include::2.x@drivers::partial$tutorials/python/sample.py[tag=replace_db]
----
...
[,python]
----
include::2.x@drivers::partial$tutorials/python/sample.py[tag=db-schema-setup]
----
...
[,python]
----
include::2.x@drivers::partial$tutorials/python/sample.py[tag=db-dataset-setup]
----
...
[,python]
----
include::2.x@drivers::partial$tutorials/python/sample.py[tag=test-db]
----
...
[,python,indent=0]
----
include::2.x@drivers::partial$tutorials/python/sample.py[tag=queries]
----
...
[,python]
----
include::2.x@drivers::partial$tutorials/python/sample.py[tag=fetch]
----
...
[,python]
----
include::2.x@drivers::partial$tutorials/python/sample.py[tag=insert]
----

We collect the response of the xref:2.x@typeql::queries/insert.adoc[Insert query] as a list
...
[,python]
----
include::2.x@drivers::partial$tutorials/python/sample.py[tag=get]
----
...
[,python]
----
include::2.x@drivers::partial$tutorials/python/sample.py[tag=update]
----
...
[,python]
----
include::2.x@drivers::partial$tutorials/python/sample.py[tag=delete]
----
