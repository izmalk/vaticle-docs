= Python driver
:page-aliases: 2.x@clients::python-driver.adoc, 2.x@clients::python-driver/overview.adoc, 2.x@clients::python/python-install.adoc, 2.x@client-api::python.adoc
...
[cols-2]
--
.xref:2.x@drivers::python/tutorial.adoc[Tutorial]
[.clickable]
****
...
include::2.x@drivers::partial$drivers2discord.adoc[]
